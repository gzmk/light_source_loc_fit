...
function costIm = renderIm_2params_light(var)
...
lightx = var(1);
lighty = var(2);
mycell = {ro_s, ro_d, alphau, lightx, lighty};



T = cell2table(mycell, 'VariableNames', {'ro_s' 'ro_d' 'alphau' 'lightx' 'lighty'});
writetable(T,'/scratch/gk925/light_source_loc_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/light_source_loc_fit');
...
imPath = ['/scratch/gk925/light_source_loc_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
